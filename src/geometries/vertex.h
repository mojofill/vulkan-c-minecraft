...
static const Vertex cube_vertices[] = {
    ...
    // ---- Left face (-X) ----
    {{-0.5f,-0.5f,-0.5f},{0,1}}, // 8
    {{-0.5f, 0.5f,-0.5f},{1,1}}, // 9
    {{-0.5f, 0.5f, 0.5f},{1,0}}, //10
    {{-0.5f,-0.5f, 0.5f},{0,0}}, //11
    ...
    {{-0.5f,-0.5f, 0.5f},{0,0}}, //17
    {{ 0.5f,-0.5f, 0.5f},{1,0}}, //18
    {{ 0.5f,-0.5f,-0.5f},{1,1}}, //19

    // ---- Front face (+Y) ----
    {{-0.5f, 0.5f,-0.5f},{0,1}}, //20
    {{ 0.5f, 0.5f,-0.5f},{1,1}}, //21
    {{ 0.5f, 0.5f, 0.5f},{1,0}}, //22
    {{-0.5f, 0.5f, 0.5f},{0,0}}, //23
};
